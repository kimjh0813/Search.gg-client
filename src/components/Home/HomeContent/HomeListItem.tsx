    ...
    <div className='h-80'>
      {/* <div className='grid grid-cols-2 auto-rows-max'>
        {CommunityItems.map((CommunityItem, index) => (
          <div
            className='h-16 border-0 border-b-2 border-solid border-gray-200 '
            key={CommunityItem.id}>
            <Link
              className='flex flex-row m-y-1 justify-center items-center h-full border-0 border-l-2 border-solid border-gray-200'
              to='/community/'>
